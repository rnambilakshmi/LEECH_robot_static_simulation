...
StrainEnergy=Energy_PartillyCompliantFourBar(kkkk);


theta=0:3*pi/36:2*pi;
plot(theta,StrainEnergy*E1*I1/L1,'-.k')
xlabel('\theta_1')
ylabel('Strain Energy V_T')
title('Strain energy in partial compliant four-bar mechanism at different crank angle')

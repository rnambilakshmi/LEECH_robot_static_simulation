...
figure(1)
delt_y=0:12e-3/Steps:12e-3;
plot(delt_y,-(kkkk(2,:)*cos(theta1)+kkkk(3,:)*sin(theta1))*E1*I1/L1^2,'o')
grid on
xlabel('\delta')
ylabel('Force')
title('Force-Displacement relationship of the fixed-guided mechanism')
toc
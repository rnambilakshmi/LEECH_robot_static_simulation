...
beta=beta0+0*pi/180:1*pi/180:beta0+60*pi/180;
figure(1)
plot(beta*180/pi,(kkkk(2,:)*LO.*cos(beta)-kkkk(3,:)*LO.*sin(beta))*E1*I1/L1^2+kkkk(37,:)*E6*I6/L6,'.-r')
xlabel('\beta')
ylabel('T_i_n')
title('Kinetostatic behavior of circular-guided mechanism')
toc